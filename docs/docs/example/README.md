...
Extracts Kafka topic metadata and prints to stdout. Uses the [enrich](../reference/processors.md#enrich) processor to append custom fields. [Learn more about dynamic recipes](../concepts/recipe.md#dynamic-recipe-value).
