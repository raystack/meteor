...
[here](../reference/extractors). `config` of an extractor can be different 
...
can visit README of each Extractor [here](../reference/extractors).
...
To get more information about the list of extractors we have, and how to define `name` field refer [here](../reference/extractors).
