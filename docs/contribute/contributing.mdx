...
- Adding a new extractor should follow [this guide](./guide#adding-a-new-extractor).
- Adding a new processor should follow [this guide](./guide#adding-a-new-processor).
- Adding a new sink should follow [this guide](./guide#adding-a-new-sink).
