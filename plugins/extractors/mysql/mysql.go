...
import (
	...
	extutil "github.com/odpf/meteor/plugins/extractors/extractorutils"
...
func (e *extutil.Extractor) Info() plugins.Info {
	return plugins.Info{
...
func (e *extutil.Extractor) Validate(configMap map[string]interface{}) (err error) {
	return utils.BuildConfig(configMap, &extutil.Config{})
}

// Init initializes the extractor
func (e *extutil.Extractor) Init(ctx context.Context, configMap map[string]interface{}) (err error) {
...
func (e *extutil.Extractor) Extract(ctx context.Context, emit plugins.Emit) (err error) {
	defer e.db.Close()
	e.emit = emit
...
func (e *extutil.Extractor) extractTables(database string) (err error) {
...
func (e *extutil.Extractor) processTable(database string, tableName string) (err error) {
...
func (e *extutil.Extractor) extractColumns(tableName string) (columns []*facetsv1beta1.Column, err error) {
...
func (e *extutil.Extractor) buildExcludedDBs() {
...
func (e *extutil.Extractor) isExcludedDB(database string) bool {
	_, ok := e.excludedDbs[database]
	return ok
}

// isNullable checks if the given string is null or not
func (e *extutil.Extractor) isNullable(value string) bool {
	return value == "YES"
}
...
func init() {
	if err := registry.Extractors.Register("mysql", func() plugins.Extractor {
		return extutil.New(plugins.GetLog())
	}); err != nil {
		panic(err)
	}
}
