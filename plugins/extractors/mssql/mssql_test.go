...
func getExpected(t *testing.T) []*meteorv1beta1.Entity {
	return []*meteorv1beta1.Entity{
		models.NewEntity("urn:mssql:test-mssql:table:mockdata_meteor_metadata_test.applicant", "table", "applicant", "mssql", map[string]any{
			"columns": []any{
		...
		models.NewEntity("urn:mssql:test-mssql:table:mockdata_meteor_metadata_test.jobs", "table", "jobs", "mssql", map[string]any{
			"columns": []any{
